...
*
* The fields are:
* int randVal: LOD 0, 1, 2. The random value generated by the FPS-R algorithm.
...
* int last_changed_frame: LOD 2. The frame when the random value last changed.
* int next_changed_frame: LOD 2. The frame when the random value will next change.
*
* 
*/
typedef struct {
